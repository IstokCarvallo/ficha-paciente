$PBExportHeader$uo_seleccion_formapago.sru
$PBExportComments$Objeto público para selección de Isapres, Todos o Consolidado
forward
global type uo_seleccion_formapago from userobject
end type
type cbx_consolida from checkbox within uo_seleccion_formapago
end type
type cbx_todos from checkbox within uo_seleccion_formapago
end type
type dw_seleccion from datawindow within uo_seleccion_formapago
end type
end forward
...
global uo_seleccion_formapago uo_seleccion_formapago

type variables
DataWindowChild	idwc_Seleccion

uo_FormaPago	iuo_Codigo
...
on uo_seleccion_formapago.create
...
on uo_seleccion_formapago.destroy
destroy(this.cbx_consolida)
destroy(this.cbx_todos)
destroy(this.dw_seleccion)
end on

event constructor;dw_Seleccion.Object.Codigo.Dddw.Name			=	'dw_mues_formapago'
dw_Seleccion.Object.codigo.Dddw.DisplayColumn	=	'fopa_nombre'
dw_Seleccion.Object.codigo.Dddw.DataColumn		=	'fopa_codigo'
...
IF	idwc_Seleccion.Retrieve() = 0 THEN
	...
	SetNull(Nombre)
ELSE
	idwc_Seleccion.SetSort("fopa_codigo A")
	idwc_Seleccion.Sort()
	...
	Codigo		=	-1
	Nombre		=	'Todas'
	iuo_Codigo	=	Create uo_FormaPago
