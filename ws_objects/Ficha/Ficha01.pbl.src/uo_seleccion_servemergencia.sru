$PBExportHeader$uo_seleccion_servemergencia.sru
$PBExportComments$Objeto público para selección de Servicios de Emergencia, Todos o Consolidado
forward
global type uo_seleccion_servemergencia from userobject
end type
type cbx_consolida from checkbox within uo_seleccion_servemergencia
end type
type cbx_todos from checkbox within uo_seleccion_servemergencia
end type
type dw_seleccion from datawindow within uo_seleccion_servemergencia
end type
end forward
...
global uo_seleccion_servemergencia uo_seleccion_servemergencia

type variables
DataWindowChild	idwc_Seleccion

uo_ServEmergencia	iuo_Codigo
...
on uo_seleccion_servemergencia.create
...
on uo_seleccion_servemergencia.destroy
destroy(this.cbx_consolida)
destroy(this.cbx_todos)
destroy(this.dw_seleccion)
end on

event constructor;dw_Seleccion.Object.Codigo.Dddw.Name			=	'dw_mues_servemergencia'
dw_Seleccion.Object.codigo.Dddw.DisplayColumn	=	'seem_nombre'
dw_Seleccion.Object.codigo.Dddw.DataColumn		=	'seem_codigo'
...
IF	idwc_Seleccion.Retrieve() = 0 THEN
	...
	SetNull(Nombre)
ELSE
	idwc_Seleccion.SetSort("seem_nombre A")
	idwc_Seleccion.Sort()
	...
	Codigo		=	-1
	Nombre		=	'Todas'
	iuo_Codigo	=	Create uo_ServEmergencia
